...
**Project**: Habit Tracker -- Local-first personal habit tracking web app (workshop clone) with a FastAPI backend and React frontend.
**Path**: `C:\AICOE\eva-foundry\21-habit-tracker\`
...
4. **Query the data model** for this project's record:
   `powershell
   Invoke-RestMethod "http://localhost:8010/model/projects/21-habit-tracker" | Select-Object id, maturity, notes
   `
...
This file is the copilot-instructions for **21-habit-tracker** (Habit Tracker).
...
Once this file has been loaded, the active project is locked to **21-habit-tracker** for the entire session.
...
**Name**: Habit Tracker
**Folder**: `C:\AICOE\eva-foundry\21-habit-tracker`
**ADO Epic**: [TODO]
**37-data-model record**: `GET /model/projects/21-habit-tracker`
**Maturity**: poc
**Phase**: Phase 1 -- Workshop Clone
...
Invoke-RestMethod "http://localhost:8010/model/endpoints/" |
  Where-Object { $_.implemented_in -like '*21-habit-tracker*' } |
